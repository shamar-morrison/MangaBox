...
export function ChapterReader({ chapterData, chapterInfo, mangaId }: ChapterReaderProps) {
  ...
  const currentImageUrl = `/api/proxy-image?url=${encodeURIComponent(`${baseUrl}/data/${hash}/${pages[currentPage]}`)}`
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2">
        <Card className="bg-gray-900/95 backdrop-blur border-gray-700 p-2">
          <div className="flex items-center gap-2">
            <Button
              variant="ghost"
              size="sm"

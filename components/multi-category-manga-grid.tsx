...
const categories: MangaCategory[] = [
  {
    ...
    endpoint:
      "https://api.mangadex.org/manga?limit=10&order[followedCount]=desc&contentRating[]=safe&contentRating[]=suggestive&includes[]=cover_art",
  ...
  },
  {
    ...
    endpoint:
      "https://api.mangadex.org/manga?limit=10&order[updatedAt]=desc&contentRating[]=safe&contentRating[]=suggestive&includes[]=cover_art",
  ...
  },
  {
    ...
    endpoint:
      "https://api.mangadex.org/manga?limit=10&order[rating]=desc&contentRating[]=safe&contentRating[]=suggestive&includes[]=cover_art",
  ...
  },
  {
    ...
    endpoint:
      "https://api.mangadex.org/manga?limit=10&order[createdAt]=desc&contentRating[]=safe&contentRating[]=suggestive&includes[]=cover_art",
    ...
    <div className="space-y-8">
      ...
      <section className="text-center py-12 bg-gradient-to-r from-purple-900/20 to-fuchsia-900/20 rounded-lg border border-purple-500/20">
        ...
        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
          Explore thousands of manga titles across all genres. From
          action-packed adventures to heartwarming romances, find your next
          favorite read on MangaBox.
        </p>
        <Button
          size="lg"
